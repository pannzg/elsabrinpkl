    ...
    <style>
        * {
        ...
        .container {
            ...
            border-radius: 20px;
            overflow: hidden;
            box-shadow: 0 15px 30px rgba(233, 150, 158, 0.3);
        }
        
        .illustration {
            flex: 1;
            background: linear-gradient(135deg, #ff8a9f 0%, #ffb6a8 100%);
            display: flex;
        ...
        .btn:hover {
            background: linear-gradient(to right, #ff8c69, #ff6b81);
...
<body>
            ...
            <form id="login-form">
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="text" id="username" placeholder="Masukkan username atau email" required>
                    </div>
                </div>
    ...
    <script>
        document.getElementById('login-form').addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                alert('Login simulasi berhasil! Dalam aplikasi nyata, ini akan mengirim data ke server.');
                btn.innerHTML = 'Masuk';
                btn.disabled = false;
            }, 1500);
        });
        
        // Menambahkan efek interaktif pada tombol sosial media
        document.querySelectorAll('.social-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                alert('Fitur login dengan ' + this.querySelector('i').parentElement.className + ' akan diimplementasikan.');
            });
        });
    </script>
</body>
