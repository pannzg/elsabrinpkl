...
<head>
    ...
    <title>{{ $category->name }} | Butik Elsabrin</title>
    ...
    <style>
        * {margin:0; padding:0; box-sizing:border-box; font-family:'Baloo 2', cursive, sans-serif;}
        ...
        /* PERUBAHAN: Gambar full card tidak terpotong */
        .product-image img {
            width: 100%;
            height: 100%;
            object-fit: cover;
        ...
        body.dark-theme .product-image {
            background: linear-gradient(135deg, #FF5D8F, #C71585);
        }
        ...
        @forelse($category->activeProducts as $product)
            <div class="product-card">
                ...
                <div class="product-content">
                    ...
                    <!-- Tombol Beli -->
                    @if($product->stock > 0)
                        <a href="{{ route('user.checkout.create', $product->id) }}" class="btn-primary">
...
// ========== TYPING EFFECT ==========
const typingTexts = [
    "✨ Temukan produk terbaik di kategori {{ $category->name }}!",
    "💖 Setiap produk dipilih dengan penuh cinta!",
    "🎀 Kualitas terjamin, harga bersahabat!",
    "🌟 Belanja mudah dengan satu klik saja!",
    "🦄 Produk eksklusif hanya untuk Anda!"
];
